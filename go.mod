...
require (
	...
	github.com/MarkRosemaker/openapi-codegen v0.0.0-20260705041456-b1c0df062ddb // indirect
	github.com/MarkRosemaker/openapi-compress v0.0.0-20260705041243-c12c4dd2b7da // indirect

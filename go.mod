...
require (
	...
	github.com/MarkRosemaker/openapi-codegen v0.0.0-20260529160337-56f2a47c5587 // indirect
	github.com/MarkRosemaker/openapi-compress v0.0.0-20260529155955-33a188f1e2b6 // indirect
